package com.jiangfengliu.controll;

import com.jiangfengliu.response.ResponseVo;
import com.jiangfengliu.spring.life.aware.BeanFactoryHelper;
import com.jiangfengliu.spring.life.factorybean.Car;
...
public class TestController {
    ...
    public User test(@PathVariable int id) {
        System.out.println("TestController test processing");
